...
from constants import PAIRS_TRADED, BUDGET, CURRENCY, THRESHOLD, DB_SETUP_TIMEOUT, GENERIC_TIMEOUT
...
async def main():
    ...
    while True:
        ...
        await execution_model.execute_portfolio_adjustments(portfolio, portfolio_changes)
